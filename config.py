...
GHOSTNETWORK_ABILITY_ALLOWED_CODES = tuple(env_csv(
    "CHAOS_GHOSTNETWORK_ABILITY_ALLOWED_CODES", "insider_feed,service_entrance,false_image,hostile_takeover,operational_prediction,expose,narrative_takeover,full_disclosure,resistance_signal,domino_effect,phantom_node",
))
