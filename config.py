...
RESPONSE_CONSEQUENCE_TABLE = {
    ...
    "detention": {
        "requires_online": True, "clock": "online_presence",
        "pause_offline": True, "resume_remaining_on_reconnect": True,
        "prison_selection": "random_once_per_sanction",
        "release_position": "pre_arrest_position",
        "block_new_encounters": True,
        "private_message_allowance": 1,
        "private_channel_scope": "all_except_world",
        "private_receive_allowed": True,
        "private_read_allowed": True,
        "message_allowance_scope": "sanction",
        "bail_minimum_hc": 250000,
        "bail_payers": ["prisoner", "other_player"],
        "bail_ends_detention": True,
        "bail_preserves_criminal_record": True,
        "essential_access": ["session", "sanction_status", "system_messages", "bail"],
    },
    "stages": {
        ...
        6: {"fine_multiplier": 0, "tools": 0, "detention_minutes": 5,
            "bail_hc": 250000,
            "restrictions": {"movement_blocked": True, "teleport_blocked": True,
                             "cyberner_world": "full", "app_access": "normal"}},
        7: {"fine_multiplier": 0, "tools": 0, "detention_minutes": 10,
            "bail_hc": 500000,
            "restrictions": {"movement_blocked": True, "teleport_blocked": True,
                             "cyberner_world": "read_only", "app_access": "normal"}},
        8: {"fine_multiplier": 0, "tools": 0, "detention_minutes": 15,
            "bail_hc": 750000,
            "restrictions": {"movement_blocked": True, "teleport_blocked": True,
                             "cyberner_world": "blocked", "app_access": "normal"}},
        9: {"fine_multiplier": 0, "tools": 0, "detention_minutes": 20,
            "bail_hc": 1000000,
            "restrictions": {"movement_blocked": True, "teleport_blocked": True,
                             "cyberner_world": "blocked", "app_access": "webdragon_radio"}},
    },
}
...
OPERATION_FEEDBACK_FLAGS = {
    ...
    "title_sequence_enabled": env_bool("CHAOS_OFS_TITLE_SEQUENCE_ENABLED", True),
}
...
GHOSTNETWORK_DROP_CHANCE = env_float("CHAOS_GHOSTNETWORK_DROP_CHANCE", 0.0)
GHOSTNETWORK_RUNTIME_MODE = str(os.environ.get("CHAOS_GHOSTNETWORK_RUNTIME_MODE", "production") or "production").strip().lower()
...
GHOSTNETWORK_ABILITY_COOLDOWN_SECONDS = max(
    GHOSTNETWORK_ABILITY_DURATION_SECONDS,
    env_int("CHAOS_GHOSTNETWORK_ABILITY_COOLDOWN_SECONDS", 60 * 60),
)
GHOSTNETWORK_RESERVATION_TTL_SECONDS = env_int("CHAOS_GHOSTNETWORK_RESERVATION_TTL_SECONDS", 15 * 60)
GHOSTNETWORK_MIN_PART_DISTANCE_KM = env_float("CHAOS_GHOSTNETWORK_MIN_PART_DISTANCE_KM", 50.0)
