...
- Artefakt trafia do `doc/sprint_131_ghostnetwork_suite_audit.md`, zgodnie z
  konwencją repo (`doc/`, nie nieistniejące `docs/ghostnetwork/`).
...
5. aktualizację `doc/game_play_180726.md`, właściwego artefaktu technicznego i
