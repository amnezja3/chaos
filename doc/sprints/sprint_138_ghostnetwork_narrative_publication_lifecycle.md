...
Status: `BLOCKED — 137.pre.1 SERVER PASS; REQUIRES SPRINT 137.1 v6 VOICE PASS`
...
takich accepted-structurally candidates. Aktywny v6 wiąże role encji, zabrania
nieudowodnionych relacji i rozdziela reguły głosu BlackNet/Googleplex. Blokada
zostanie zdjęta dopiero po nowym producer-backed candidate v6 z technicznym i
ręcznym PASS.
