...
- immutable prompty `blacknet-signal-prompt-v6` oraz
  `googleplex-world-hero-prompt-v11`, opisujące role bez przykładów odpowiedzi;
...
- 100 testów kolejki, policy, producentów, publishera i projekcji: PASS.
...
WHERE prompt_version IN ('blacknet-signal-prompt-v6',
                         'googleplex-world-hero-prompt-v11')
...
kopią całego `title/label/value/stat`.
