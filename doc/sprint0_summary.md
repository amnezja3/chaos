...
| Dokument | Rola |
| --- | --- |
| `doc/name_of_game.md` | Nazwa gry, rozwinięcie CHAOS i hasło. |
| `doc/plan_zero_gameplay_base.md` | Plan bazowy Sprintu 0 i zakres kontraktów. |
| `doc/gameplay_terms.md` | Słownik pojęć, identyfikatorów i zasad rozdzielenia odpowiedzialności. |
| `doc/source_type_mapping.md` | Mapowanie `source_type -> target_type`. |
| `doc/world_objects.md` | Model obiektów świata. |
| `doc/map_actions.md` | Kontrakt akcji mapy. |
| `doc/app_contract.md` | Kontrakt aplikacji. |
| `doc/gameplay_matrix.md` | Macierz gameplayu i szybka tabela relacji akcja-operacja-zasób. |
| `doc/operations.md` | Kontrakt operacji jako centralnego bytu gameplayu. |
| `doc/movement_model.md` | Model aktywnego świata i odświeżania bez realtime loopa. |
| `doc/resource_types.md` | Model danych i zasobów produkowanych przez operacje. |
| `doc/file_model.md` | System plików jako gameplay inventory. |
| `doc/data_economy.md` | Ekonomia danych, Ghost Exchange i cykl życia sprzedaży. |
| `doc/risk_events.md` | Kontrakt systemu ryzyka. |
| `doc/gameplay_loop.md` | Pełna pętla gameplayu. |
| `doc/sprint0_summary.md` | Zamknięcie Sprintu 0 i mapa źródeł prawdy. |

Dokumenty historyczne / robocze:

| Dokument | Status |
| --- | --- |
| `doc/game_play_260626.md` | Dokument koncepcyjny, źródło inspiracji, nie główny kontrakt. |
| `doc/action_player.md` | Historia i plan player actions / player actor, pomocniczy wobec Sprintu 0. |
