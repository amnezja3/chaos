...
| `.4.4` | S4 Accord Relay / `mediator` | Korytarz Zaufania | `operation_risk` | certyfikowane `heat -15` dla maks. 8 istniejących oraz wszystkich nowych operacji podczas okna | `IMPLEMENTED / SERVER E2E TEST PENDING` |
