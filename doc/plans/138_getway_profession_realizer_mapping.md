...
| `.1.2` | V2 Backdoor Forge / `architect` | Wejście Serwisowe | `hack_actions` | wszystkie cztery kropki aktualnie oznaczonego celu wykonane; zabezpieczenia pozostają | `STRONG FIT` |
