...
## Regresja zgłoszona 17 IX 2026 — sprint 142.1

Historyczny PASS poniżej dotyczy odbioru 7 IX. Autor ponownie zgłosił złe menu
kamer po wdrożeniu 142.1. `addInteractiveTargetMarker` nie podpinał capture
bindingu stosowanego dla markerów surowego scanu. Dodano go oraz ponowne
