...
- coordinate-backed akcja zawsze rozwiązuje canonical `lat/lng` przed legacy
  aliasem hotspotu; `INCYDENT <lat,lng>` pozostaje display label, a incydenty
  używają bezpiecznego `focus_map_target` bez automatycznego teleportu;
