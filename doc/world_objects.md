...
Szczegółowe mapowanie `source_type -> target_type` znajduje się w `doc/source_type_mapping.md`.
...
* Nowy `source_type` powinien dostać wpis w `doc/source_type_mapping.md`.
