...
<link rel="stylesheet" href="/static/css/style.css?v=signal-show-stylization-2-depth-2">
...
<script src="/static/js/ghost_signal_show.js?v=signal-show-stylization-2-depth-2"></script>
<script>
