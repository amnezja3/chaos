...
<link rel="stylesheet" href="/static/css/style.css?v=signal-show-stylization-4-hero-overflow-1">
...
<script src="/static/js/ghost_signal_show.js?v=signal-show-stylization-4-hero-overflow-1"></script>
<script>
