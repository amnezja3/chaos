...
<link rel="stylesheet" href="/static/css/style.css?v=signal-show-media-2">
...
<script src="/static/js/ghost_radio.js?v=radio-show-media-2"></script>
...
<script src="/static/js/ghost_signal_show.js?v=signal-show-media-2"></script>
<script>
