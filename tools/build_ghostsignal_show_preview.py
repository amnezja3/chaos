...
<link rel="stylesheet" href="/static/css/style.css?v=signal-show-stylization-3-network-2">
...
<script src="/static/js/ghost_signal_show.js?v=signal-show-stylization-3-network-2"></script>
<script>
