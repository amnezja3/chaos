...
GHOSTNETWORK_EVENT_PROMPT_VERSION = "ghostnetwork-event-prompt-v11"
GHOSTNETWORK_SIGNAL_PROMPT_VERSION = "ghostsignal-prompt-v11"
GHOSTNETWORK_GOOGLEPLEX_PROMPT_VERSION = "ghostnetwork-googleplex-prompt-v11"
...
def _build_registry():
    ...
    policies.append(_policy(
        ...
        Path("ghostnetwork") / "googleplex-v11.md",
        ASSET_OUTPUT_SCHEMA_VERSION,
        semantic_input=True,
    ))
    policies.extend((
    ...
    for variant in sorted(GHOSTNETWORK_BLACKNET_VARIANTS):
        ...
        policies.append(_policy(
            ...
            (Path("ghostsignal") / "signal-v11.md") if is_signal
            else (Path("ghostnetwork") / "event-v11.md"),
            semantic_input=True,
        ))
    ...
    policies.append(_policy(
        ...
        Path("ghostsignal") / "signal-v11.md",
        semantic_input=True,
    ))
    policies.append(_policy(
...
OLLAMA_LEGACY_TASK_POLICIES = (
    ...
    + _build_legacy_ghostnetwork_policies(
        "ghostnetwork-event-prompt-v6", Path("ghostnetwork") / "event-v6.md",
        "ghostsignal-prompt-v6", Path("ghostsignal") / "signal-v6.md",
        "ghostnetwork-googleplex-prompt-v6", Path("ghostnetwork") / "googleplex-v6.md",
        semantic_input=True,
    )
    + _build_legacy_ghostnetwork_policies(
        "ghostnetwork-event-prompt-v7", Path("ghostnetwork") / "event-v7.md",
        "ghostsignal-prompt-v7", Path("ghostsignal") / "signal-v7.md",
        "ghostnetwork-googleplex-prompt-v7", Path("ghostnetwork") / "googleplex-v7.md",
        semantic_input=True,
    )
    + _build_legacy_ghostnetwork_policies(
        "ghostnetwork-event-prompt-v8", Path("ghostnetwork") / "event-v8.md",
        "ghostsignal-prompt-v8", Path("ghostsignal") / "signal-v8.md",
        "ghostnetwork-googleplex-prompt-v8", Path("ghostnetwork") / "googleplex-v8.md",
        semantic_input=True,
    )
    + _build_legacy_ghostnetwork_policies(
        "ghostnetwork-event-prompt-v9", Path("ghostnetwork") / "event-v9.md",
        "ghostsignal-prompt-v9", Path("ghostsignal") / "signal-v9.md",
        "ghostnetwork-googleplex-prompt-v9", Path("ghostnetwork") / "googleplex-v9.md",
        semantic_input=True,
    )
    + _build_legacy_ghostnetwork_policies(
        "ghostnetwork-event-prompt-v10", Path("ghostnetwork") / "event-v10.md",
        "ghostsignal-prompt-v10", Path("ghostsignal") / "signal-v10.md",
        "ghostnetwork-googleplex-prompt-v10", Path("ghostnetwork") / "googleplex-v10.md",
        semantic_input=True,
    )
)
