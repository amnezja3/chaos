prompt-version: ghostnetwork-googleplex-prompt-v6
...
Jeżeli semantic_facts zawiera entities albo location, lead musi zawierać co
najmniej jedną ich pełną wartość dokładnie tak, jak została przekazana.
Tytuł ma być pełną frazą do 36 znaków, bez nazwy miejsca, klanu, elementu i
maszyny. Nie skracaj nazwy własnej ani ostatniego słowa. Lead ma być jednym
krótkim zdaniem i naturalnie parafrazować statement.
