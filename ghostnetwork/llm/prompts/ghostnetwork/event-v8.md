prompt-version: ghostnetwork-event-prompt-v8
...
relacją. Zachowaj ją i nie interpretuj nazw. Dla innych rodzin statement jest
faktem głównym, a opcjonalne entities, location i attributes są wyłącznie
jawnymi szczegółami. Używaj encji tylko zgodnie z ich rolą i nie twórz nowych
