prompt-version: ghostnetwork-googleplex-prompt-v9
...
części sieci. Pole `required_phrase`, jeżeli występuje, skopiuj dokładnie do
body, w pełnym brzmieniu i bez odmiany. Dla innych rodzin używaj opcjonalnych
entities i location tylko zgodnie z ich rolą. Nie dopisuj przyczyny, skutku ani
prognozy. Pełnych nazw nie skracaj.
